...
Lightkite records the operation history of Kubernetes resources (create, update, delete, and changes via YAML Apply). On the details page, you can view the time of each change, the operator, whether it succeeded, and the YAML differences before and after the change, and roll back as needed.
